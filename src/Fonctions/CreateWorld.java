...
public class CreateWorld {
	...
	public void Creationworld() {
		...
		main.list_maps.add(new Map(2, "Japon", new Location(main.world, 443, 216, -558),
				new ArrayList<Location>(Arrays.asList(new Location(main.world, 404, 65, -602),
						new Location(main.world, 410, 64, -514))),
				new ArrayList<Location>(Arrays.asList(new Location(main.world, 434, 76, -642),
						new Location(main.world, 428, 71, -487))),
				new Location(main.world, 439, 60, -558), new Location(main.world, 357, 0, -676),
