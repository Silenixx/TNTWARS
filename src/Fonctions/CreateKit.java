...
/*   92 */         Arrays.asList( "§bArmure en fer", "§bEp§e en diamant", "§dCe kit est fait pour les mordues de PVP.", "§dVous ferez partie des combattants majeurs de votre équipe."
/*   93 */            ), "tnt.guerrier");
...
/*  114 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.ENDER_PEARL, 3), new ItemStack(Material.CHORUS_FRUIT, 10)
/*  115 */             )), null, 
/*  116 */         true, 
/*  117 */         new ItemStack(Material.ENDER_PEARL), 
/*  118 */         Arrays.asList( "§bEp§e en fer", "§btest\",\"§dtest"
/*  119 */            ), "tnt.enderman");
...
/*  167 */         Arrays.asList( "§bArmure en fer protection explosion", "§bEpee en fer", "§dIncarnez un creeper"
/*  168 */            ), "tnt.creeper");
...
/*  195 */         Arrays.asList( "§bEpee en netherite\",\"§bPas d'armure", "§dUn coup d'§p§e et il est mort"
/*  196 */           ), "tnt.oneshot");
...
/*  219 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.FIREWORK_ROCKET, 1)
/*  220 */             )), null, 
/*  221 */         true, 
/*  222 */         new ItemStack(Material.ELYTRA), 
/*  223 */         Arrays.asList( "§bEpee en pierre\",\"§bUne paire d'élytre et une rocket", "§denvolez vous dans les cieux"
/*  224 */           ), "tnt.elytra");
...
/*  261 */         new ArrayList<ItemStack>(Arrays.asList(is_Ninja, is2_Ninja, new ItemStack(Material.BLACK_BANNER, 3), new ItemStack(Material.GOLDEN_APPLE, 5)
/*  262 */             )), null, 
/*  263 */         true, 
/*  264 */         new ItemStack(Material.BLACK_BANNER), 
/*  265 */         Arrays.asList( "§btest\",\"btest\",\"dtest"
/*  266 */           ), "tnt.ninja");
...
/*  290 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.AMETHYST_SHARD, 3), new ItemStack(Material.AMETHYST_CLUSTER, 3)
/*  291 */             )), null, 
/*  292 */         true, 
/*  293 */         new ItemStack(Material.AMETHYST_SHARD), 
/*  294 */         Arrays.asList( "§bEpee en pierre", "§bDe quoi soigner", "§dMerci toubib"
/*  295 */           ), "tnt.savior");
...
/*  320 */         new ArrayList<ItemStack>(Arrays.asList(customcarrot, customcarrot, customcarrot, customcarrot, customcarrot, new ItemStack(Material.SADDLE, 6), new ItemStack(Material.PIG_SPAWN_EGG, 6)
/*  321 */             )), null, 
/*  322 */         true, 
/*  323 */         new ItemStack(Material.CARROT_ON_A_STICK), 
/*  324 */         Arrays.asList( "§bCanne § p§che carotte\",\"§bUne horde de cochons", "§dDevenez un v§ritable dresseur"
/*  325 */           ), "tnt.pigrider");
...
/*  351 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.HORSE_SPAWN_EGG, 1), new ItemStack(Material.SADDLE, 1), new ItemStack(Material.WHEAT, 64), new ItemStack(Material.WHEAT, 64)
/*  352 */             )), null, 
/*  353 */         true, 
/*  354 */         new ItemStack(Material.SADDLE), 
/*  355 */         Arrays.asList( "§bUne §p§e en fer\",\"§bUne armure en fer", "§dUn cheval et vous voila au moyen-age"
/*  356 */           ), "tnt.chevalier");
...
/*  389 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.PARROT_SPAWN_EGG, 3), new ItemStack(Material.WHEAT_SEEDS, 64), new ItemStack(Material.SPYGLASS), new ItemStack(Material.GOLDEN_APPLE, 2)
/*  390 */             )), null, 
/*  391 */         true, 
/*  392 */         new ItemStack(Material.SPYGLASS), 
/*  393 */         Arrays.asList( "§bUne §p§e en fer\",\"§bUne armure en fer", "§dL'apn§e ca vous connait, ne seriez vous pas Jack Sparrow?"
/*  394 */           ), "tnt.pirate");
...
/*  418 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.BONE, 64), new ItemStack(Material.WOLF_SPAWN_EGG, 7)
/*  419 */             )), null, 
/*  420 */         true, 
/*  421 */         new ItemStack(Material.BONE), 
/*  422 */         Arrays.asList( "§bUne §p§e en fer\",\"§bUne armure en fer", "§dUne horde de loup, un vrai §l§veur"
/*  423 */           ), "tnt.dogmaster");
...
/*  452 */         new ArrayList<ItemStack>(Arrays.asList(customtrident_Trident
/*  453 */             )), null, 
/*  454 */         true, 
/*  455 */         new ItemStack(Material.TRIDENT), 
/*  456 */         Arrays.asList( "§bUne §p§e en pierre et un tridant\",\"§bUne armure en fer", "§dQui vois je , Aquaman c'est toi?"
/*  457 */           ), "tnt.trident");
...
/*  479 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.INK_SAC)
/*  480 */             )), null, 
/*  481 */         true, 
/*  482 */         new ItemStack(Material.INK_SAC), 
/*  483 */         Arrays.asList( "§bUne §p§e en fer\",\"§bUne armure en fer", "§dRendez aveugle vos adversaires"
/*  484 */           ), "tnt.squid");
...
/*  510 */         Arrays.asList( "§bUne §p§e en diamant\",\"§bUne armure en fer et chaine", "§dUne vrai brute, quel carnage!!"
/*  511 */           ), "tnt.barbare");
...
/*  533 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.SNOWBALL, 64), new ItemStack(Material.SNOWBALL, 64), new ItemStack(Material.SNOWBALL, 64), new ItemStack(Material.SNOWBALL, 64)
/*  534 */             )), null, 
/*  535 */         true, 
/*  536 */         new ItemStack(Material.SNOWBALL), 
/*  537 */         Arrays.asList( "§bUne §p§e en fer\",\"§bUne armure en fer", "§dRedenvez un enfant et faites une bataille de boule de neige"
/*  538 */           ), "tnt.snowman");
...
/*  565 */         Arrays.asList( "§bArmure en diamand", "§bEpe en pierre", "§dCe kit n'est pas fait pour la ngociation.", "§dLancez vous dans le combat avec pour craser vos enemeies"
/*  566 */           ), "tnt.tank");
...
/*  593 */         new ArrayList<ItemStack>(Arrays.asList(custombow_archer, new ItemStack(Material.ARROW)
/*  594 */             )), null, 
/*  595 */         true, 
/*  596 */         new ItemStack(Material.BOW), 
/*  597 */         Arrays.asList( "§bArc enchant", "§bArmure en maille", "§dLe kit archer est un soutien essentiel pour votre §quipe."
/*  598 */           ), "tnt.archer");
...
/*  627 */         new ArrayList<ItemStack>(Arrays.asList(customblaze_sorcier
/*  628 */             )), null, 
/*  629 */         true, 
/*  630 */         new ItemStack(Material.BLAZE_ROD), 
/*  631 */         Arrays.asList( "§bUne baguette magiue\",\"§bUne armure en fer", "§dDevenez un vrai magicien \",\"§dle temps d'une partie"
/*  632 */           ), "tnt.sorcier");
...
/*  652 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.COOKED_BEEF, 64), new ItemStack(Material.COOKED_BEEF, 64)
/*  653 */             )), null, 
/*  654 */         false, 
/*  655 */         new ItemStack(Material.ENDER_EYE), 
/*  656 */         Arrays.asList( "§bEpe en bois", "§bTotalement invisible", "§dLe kit Ghost vous rendra invisivle pour ", "§dinfiltrer les lignes enemies. Soyez discret et assasin."
/*  657 */           ), "tnt.ghost");
...
/*  680 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.GLISTERING_MELON_SLICE)
/*  681 */             )), null, 
/*  682 */         true, 
/*  683 */         new ItemStack(Material.GLISTERING_MELON_SLICE), 
/*  684 */         Arrays.asList( "§bÉpée en pierre", "§bArmure maille", "§dLe kit des medecins, utilisez-le ", "§dpour soigner vos compagnons."
/*  685 */           ), "tnt.Healer");
...
/*  714 */         new ArrayList<ItemStack>(Arrays.asList(custombow
/*  715 */             )), null, 
/*  716 */         true, 
/*  717 */         new ItemStack(Material.FLINT_AND_STEEL), 
/*  718 */         Arrays.asList( "§bEpee en pierre", "§bArmure fer", "§dPour les pyroman du dimanche "
/*  719 */           ), "tnt.pyro");
...
/*  746 */         Arrays.asList( "§bEpee en fer", "§bArmure fer", "§dCa manque de d§co ici! "
/*  747 */           ), "tnt.builder");
...
/*  781 */         new ArrayList<ItemStack>(Arrays.asList(is
/*  782 */             )), null, 
/*  783 */         true, 
/*  784 */         new ItemStack(Material.POTION), 
/*  785 */         Arrays.asList( "§bEpee en fer", "§bArmure fer", "§dUn petit §lixir, Monseigneur? "
/*  786 */           ), "tnt.alchimiste");
...
/*  814 */         new ArrayList<ItemStack>(Arrays.asList(customblaze_Gandalf
/*  815 */             )), null, 
/*  816 */         true, 
/*  817 */         new ItemStack(Material.STICK), 
/*  818 */         Arrays.asList( "§bUne baguette magique", "§bArmure fer", "§dVOUS NE PASSEREZ PAAAAAAAAAS "
/*  819 */           ), "tnt.gandalf");
...
/*  837 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.SHIELD)
/*  838 */             )), null, 
/*  839 */         true, 
/*  840 */         new ItemStack(Material.SHIELD), 
/*  841 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  842 */           ), "tnt.shield");
...
/*  866 */         new ArrayList<ItemStack>(Arrays.asList(customArbalette, new ItemStack(Material.ARROW)
/*  867 */             )), null, 
/*  868 */         true, 
/*  869 */         new ItemStack(Material.CROSSBOW), 
/*  870 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  871 */           ), "tnt.arbalette");
...
/*  889 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.FIRE_CHARGE, 20)
/*  890 */             )), null, 
/*  891 */         true, 
/*  892 */         new ItemStack(Material.FIRE_CHARGE), 
/*  893 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  894 */           ), "tnt.ghast");
...
/*  913 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.SHULKER_BOX))),
					null, 
/*  915 */         true, 
/*  916 */         new ItemStack(Material.SHULKER_BOX), 
/*  917 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  918 */           ), "tnt.shulker");
...
/*  935 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.COBWEB)
/*  936 */             )), null, 
/*  937 */         true, 
/*  938 */         new ItemStack(Material.COBWEB), 
/*  939 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  940 */           ), "tnt.spider");
...
/*  957 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.WITHER_ROSE)
/*  958 */             )), null, 
/*  959 */         true, 
/*  960 */         new ItemStack(Material.WITHER_SKELETON_SKULL), 
/*  961 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  962 */           ), "tnt.wither");
...
/*  991 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/*  992 */           ), "tnt.pandaman");
...
/* 1009 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.CRIMSON_FUNGUS))),
null, 
/* 1011 */         true, 
/* 1012 */         new ItemStack(Material.CRIMSON_FUNGUS), 
/* 1013 */         Arrays.asList( "b§test\",\"§btest\",\"§dtest"
/* 1014 */           ), "tnt.poison");
...
/* 1038 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.FISHING_ROD), new ItemStack(Material.PUFFERFISH)
/* 1039 */             )), null, 
/* 1040 */         true, 
/* 1041 */         new ItemStack(Material.FISHING_ROD), 
/* 1042 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1043 */           ), "tnt.pecheur");
...
/* 1067 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1068 */           ), "tnt.rocketman");
...
/* 1086 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.BLAZE_ROD)
/* 1087 */             )), null, 
/* 1088 */         true, 
/* 1089 */         new ItemStack(Material.BLAZE_ROD), 
/* 1090 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1091 */           ), "tnt.blaze");
...
/* 1110 */         new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.NETHER_BRICK)
/* 1111 */             )), null, 
/* 1112 */         true, 
/* 1113 */         new ItemStack(Material.END_ROD), 
/* 1114 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1115 */           ), "tnt.evocateur");
...
/* 1146 */         new ArrayList<ItemStack>(Arrays.asList(custombow_archer2, new ItemStack(Material.ARROW))),
					null, 
/* 1148 */         true, 
/* 1149 */         new ItemStack(Material.ARROW), 
/* 1150 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1151 */           ), "tnt.archer2");
...
/* 1174 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1175 */           ), "tnt.tacticien");
...
/* 1198 */         Arrays.asList( "btest\",\"btest\",\"dtest"
...
/* 1216 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1217 */           ), "tnt.spy");
...
/* 1233 */         Arrays.asList( "btest\",\"btest\",\"dtest"
/* 1234 */           ), "tnt.hasard");
