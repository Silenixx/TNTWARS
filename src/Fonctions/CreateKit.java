...
public class CreateKit {
	...
	public static ArrayList<Kit> CreationKit() {
		...
		Kit Endermen = new Kit("Endermen",null,null,null,null,null,Vie_Global_Joueur,null,null,true);
		list_kits.add(Endermen);
		Kit Kamikaze=new Kit("Kamikaze",null,null,null,null,null,Vie_Global_Joueur,null,null,true);
		list_kits.add(Kamikaze);
		Kit OneShot=new Kit("OneShot",null,null,null,null,null,1,null,null,true);
		list_kits.add(OneShot);
		Kit Elytra=new Kit("Elytra",null,null,null,null,null,Vie_Global_Joueur,null,null,true);
		list_kits.add(Elytra);
		Kit Ninja=new Kit("Ninja",null,null,null,null,null,Vie_Global_Joueur,null,null,true);
		list_kits.add(Ninja);
