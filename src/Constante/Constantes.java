 ...
 {
   public static final String PluginRules = 
		   "§6Bienvenue dans le TntWars. Le principe est simple, plusieurs équipes s'affrontent en protégeant la tnt de leur camp et tente de faire exploser celle de l'adversaire."
		   + ""
		   ...
		   + ""
		   + " Une fois allumée la tnt mettra 30 secondes avant d'exploser."
		   + ""
		   ...
		   + ""
		   + " Pour vous aider à accomplir votre objectif, vous aurez accès à une grande quantité de Kits. Utilisez la Nether-Star pour en selectionner un."
		   + ""
		   ;
